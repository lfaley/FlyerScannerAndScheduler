...
SYMBOLS = {
 ...
 'pan':           '<path d="M3.2 11.6h12.4v2.2a6.2 6.2 0 0 1-12.4 0z"/><path d="M15.6 12.6h2.6a2.6 2.6 0 0 0 0-5.2h-.9"/><path d="M6.4 8.6c0-1.4 1.6-1.4 1.6-2.8M10 8.6c0-1.4 1.6-1.4 1.6-2.8"/>',
