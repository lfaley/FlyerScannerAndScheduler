...
export const AI_ACTIONS = [
  ...
  },
  {
    ...
    cannot: 'Nothing here happens without your say-so. It shows you exactly what it is about to do and waits for you to say yes, it refuses to guess when two things could be meant, and every change it makes can be undone.',
    fallback: 'Every one of these is a tap on the screen it belongs to.',
  },
  {
    id: 'emailbrief',
    label: 'Read emails that would not import, unasked',
    risk: RISK.READ,
    can: 'Reads an email your watcher fetched but could not pull any dates out of — the body text and any photo — and tells you who it is from, what it is about in one line, any date it names, and what to do about it. It starts on its own, so the answer is waiting when you open the review screen.',
    cannot: 'It reads and reports: nothing is saved until you tap Add as event. It only ever reads emails your watcher already fetched and could not import, never the rest of your mail. And it runs by itself only while Gordon is answering — if reading one would fall to Anthropic and use your key, which a PDF or Gordon being offline both do, it stops there and hands the rest back to you.',
